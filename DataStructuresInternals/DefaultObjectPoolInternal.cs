...
public class DefaultObjectPoolInternal<T> : ObjectPool<T> where T : class
{
    ...
    public DefaultObjectPoolInternal(IPooledObjectPolicy<T> policy)
    ...
    public DefaultObjectPoolInternal(IPooledObjectPolicy<T> policy, int maximumRetained)
    {
